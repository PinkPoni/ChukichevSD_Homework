...
// РЕШЕНИЕ.
// Судя, по примеру выше, позиция элемента массива задается не номером индекса строки и столбца, а порядковым
// номером элемента в массиве. В результате 17-й элемент отстуствет в масиве из 16 элементов.
// Поэтому в решении ниже под позицией элемента понимается его порядковый номер от начала массива, начиная 
// с 1 позиции, например: 6-й элемент, 12-й, 52-й и т.д.
